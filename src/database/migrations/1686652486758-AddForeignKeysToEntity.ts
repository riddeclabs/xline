...
export class AddForeignKeysToEntity1686652486758 implements MigrationInterface {
    name = "AddForeignKeysToEntity1686652486758";
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "crypto_transaction" ADD CONSTRAINT "UQ_b97d431367633624d9a1596e93f" UNIQUE ("payment_processing_tx_id")`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "crypto_transaction" ADD CONSTRAINT "UQ_78c95aea7b49d15daf7ddf44a48" UNIQUE ("tx_hash")`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "credit_line" ADD CONSTRAINT "FK_cc806b89dec6e8f11f1c04dd871" FOREIGN KEY ("economical_parameters_id") REFERENCES "economical_parameters"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "crypto_transaction" DROP CONSTRAINT "UQ_78c95aea7b49d15daf7ddf44a48"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "crypto_transaction" DROP CONSTRAINT "UQ_b97d431367633624d9a1596e93f"`
        );
        await queryRunner.query(
